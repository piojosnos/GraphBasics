...
public class GraphAdjacencyListEdgeIterator<NODE> implements Iterator<Edge<NODE>> {
    ...
    public GraphAdjacencyListEdgeIterator(Direction direction, NODE node, Iterator<Edge<NODE>> itt) {
