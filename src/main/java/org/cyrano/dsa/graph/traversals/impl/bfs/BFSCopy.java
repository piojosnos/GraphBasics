...
public class BFSCopy<NODE> implements Traversal<NODE, BFSNodeMetadata<NODE>> {
...
//    @Override
//    public void traverse(Graph graph, Visitor visitor, int begNode) {
//        this.begNode = begNode;
//
//        Queue<Integer> queue = new LinkedList<>();
//
//        getNodeMetadata(begNode).proc();
//
//        queue.add(begNode);
//
//        while (!queue.isEmpty()) {
...
//
//            getNodeMetadata(curr).proc();
//
//            //Iterator<Edge> itt = curr.adjacent();
//            Iterator<Edge> itt = graph.adjacent(curr);
//
//            while (itt.hasNext()) {
//                Edge edge = itt.next();
//
//                BFSNodeMetadata bfsNodeMetadata = getNodeMetadata(edge.getTarget());
//
//                if (!bfsNodeMetadata.isDisc()) {
//                    queue.add(edge.getTarget());
//                    bfsNodeMetadata.disc(edge.getSource());
//                }
//
//                if (!bfsNodeMetadata.isProc()) {
//                    visitor.visit(edge);
//                }
//            }
//
